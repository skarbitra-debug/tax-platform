    ...
    <div className="landing-card rounded-3xl p-6 sm:p-10">
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-8">
          <div>
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-lg font-bold text-white">{clients}</span>
            </div>
            <input
              type="range"
              min={1}
          ...
          <div>
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-lg font-bold text-white">{rub(avgRefund)}</span>
            </div>
            <input
              type="range"
              min={100_000}
        ...
        <div className="flex flex-col justify-center rounded-2xl border border-white/10 bg-black/20 p-8 text-center">
          ...
          <div className="mt-2 text-5xl font-bold text-emerald-gradient">{rub(perMonth)}</div>
          <div className="mt-6 grid grid-cols-2 gap-4 border-t border-white/10 pt-6 text-sm">
            <div>
              <div className="font-semibold text-white">{rub(perClient)}</div>
              <div className="text-xs text-white/40">с одного клиента</div>
            </div>
            <div>
              <div className="font-semibold text-white">{rub(perYear)}</div>
              <div className="text-xs text-white/40">в год</div>
            </div>
          </div>
        </div>
      </div>
