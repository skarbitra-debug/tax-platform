...
export function DashboardPreview() {
  return (
    <div className="landing-card overflow-hidden rounded-2xl" aria-hidden="true">
      {/* Хром окна браузера */}
      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          <div className="text-xs text-white/55">Ваша партнёрская ссылка</div>
        ...
        <div className="mt-4 grid grid-cols-3 gap-3">
          {[
            ...
            <div key={s.l} className="rounded-xl border border-white/10 bg-white/[0.03] p-3 text-center">
              <div className="whitespace-nowrap text-base font-bold text-emerald-gradient sm:text-lg">{s.v}</div>
          ...
          {DEALS.map((d) => (
            ...
            >
              <div>
                ...
                <div className="text-xs text-white/55">налог {d.tax}</div>
              </div>
